...
const EmployeeHome = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-6 justify-center">
      {/* Profile */}
      <div className="bg-white dark:bg-gray-800 shadow-lg border border-gray-300 dark:border-gray-700 rounded-lg p-2 w-auto h-fit">
        <Profile />
      </div>
      ...
      {/* Performance */}
      <div className="bg-white dark:bg-gray-800 shadow-lg border border-gray-300 dark:border-gray-700 rounded-lg p-2 w-full h-fit">
        <Performance />
      </div>
